...
test("Não deve criar um financiamento imobiliário caso a parcela ocupa um valor superior a 25% a renda mensal", function() {
...
test("Não deve criar um financiamento veicular caso a parcela ocupa um valor superior a 30% a renda mensal", function() {
